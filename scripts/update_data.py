...
────────────────────────────────────────────
Fetches live market data for 328 tickers and writes market_data.csv.
GitHub Actions runs this every weekday at 06:00 UTC.

Estimated runtime: ~22 minutes (328 tickers × 4s each)
GitHub Actions job limit: 6 hours — well within limits.
"""
...
TICKERS = [
    ...
    "C","BAC","GS","MS","WFC",
    # TECH
    "GOOGL","AMZN","META","NVDA","TSLA","ORCL","CRM","ADBE","INTC","AMD",
    "QCOM","TXN","CSCO","IBM","NOW","AMAT","MU","LRCX","KLAC","SNPS",
    "CDNS","PANW","CRWD","FTNT","NET","DDOG","ZS","TEAM","HUBS","WDAY",
    "SNOW","PLTR","APP","UBER","LYFT","ABNB","DASH","SPOT","RBLX","U",
    "HOOD","COIN","MSTR","TSM","AVGO","ASML","MRVL","MPWR","ON","NXPI",
    "STM","SWKS","QRVO","ENTG","MKSI","INTU","ADSK","ANSS","PTC","GWRE",
    "VEEV","TTD","ROKU","ZM","DOCN","BOX","SMAR","SAP","PAYC",
    # FINANCIALS
    "BRK-B","V","MA","AXP","BLK","SCHW","USB","PNC","TFC","COF",
    "DFS","SYF","AIG","MET","PRU","ALL","TRV","PGR","CB","MMC",
    "AON","ICE","CME","SPGI","MCO","MSCI","FI","FIS","GPN","WEX",
    # HEALTHCARE
    "UNH","LLY","ABBV","MRK","PFE","TMO","ABT","DHR","BMY","AMGN",
    "GILD","ISRG","SYK","BSX","HCA","ELV","CI","HUM","CNC","MOH",
    "ZBH","BAX","BDX","EW","HOLX","IDXX","IQV","MCK","COR","CAH",
    "BIIB","REGN","VRTX","MRNA","BNTX","ALNY","INCY","EXAS","IONS",
    # CONSUMER
    "WMT","COST","HD","LOW","TGT","MCD","SBUX","NKE","TJX","BKNG",
    "EXPE","YUM","QSR","DPZ","DKNG","LVS","WYNN","CZR","MGM",
    "KO","PEP","MDLZ","GIS","K","CAG","SJM","HRL","TSN","MKC",
    "CLX","CL","KMB","CHD","EL","ULTA",
    # ENERGY
    "XOM","CVX","COP","SLB","EOG","MPC","PSX","VLO","OXY","HAL",
    "DVN","FANG","BKR","HES","MRO","APA","CTRA","EQT","RRC","AR","NOV",
    # INDUSTRIALS
    "BA","CAT","GE","HON","RTX","LMT","UPS","FDX","DE","MMM",
    "NOC","GD","HII","LHX","TDG","HWM","TXT","AXON","IR","ITW",
    "EMR","ETN","ROK","AME","PH","DOV","FAST","GWW","CTAS","VRSK",
    "BR","ADP","PAYX",
    # UTILITIES
    "NEE","DUK","SO","D","AEP","EXC","XEL","ES","ED","PCG",
    "EIX","WEC","DTE","ETR","FE","AES","NRG","VST",
    # REAL ESTATE
    "PLD","AMT","EQIX","SPG","O","WELL","DLR","PSA","EXR","VICI",
    "WPC","NNN","ARE","BXP","KIM",
    # AIRLINES/TRAVEL
    "UAL","DAL","ALK","NCLH","RCL","HLT","MAR","H",
    # TELECOM/MEDIA
    "T","VZ","TMUS","LUMN","DIS","NFLX","WBD","FOX","PARA","CMCSA",
    "CHTR","EA","TTWO","LYV",
    # MATERIALS
    "LIN","APD","ECL","DD","DOW","LYB","PPG","SHW","NEM","FCX",
    "NUE","STLD","CLF","X","AA","CF","MOS","IFF","ALB","MP",
]
...
SHORT_KEYS=["Current Debt","Short Term Debt","CurrentDebt","Short Long Term Debt","ShortTermDebt","Current Debt And Capital Lease Obligation"]
LONG_KEYS=["Long Term Debt","LongTermDebt","Long Term Debt And Capital Lease Obligation","Long-Term Debt"]
    ...
    for attempt in range(1,4):
        try:
            ...
            if hist.empty or len(hist)<20:
                logger.warning("  %s insufficient history",ticker)
                time.sleep(attempt*5); continue
